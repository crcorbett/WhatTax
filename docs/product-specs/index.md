...
| Spec | Status | Notes |
| --- | --- | --- |
| [Harness foundation improvements](./harness-foundation-improvements.md) | Active | HFI-004 qualifies fail-closed candidate `7c8a96e`; HFI-005 must reconcile current owners and close the lifecycle. |
