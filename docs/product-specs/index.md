...
| Spec | Status | Notes |
| --- | --- | --- |
| [Oxlint policy refresh](./oxlint-policy-refresh.md) | Active | OLP-001 is installing the current generic and Effect anti-slop policy, preserving TaxKit's stricter local rules, and proving the change locally and in hosted Quality before merge. |
