...
| Spec | Status | Notes |
| --- | --- | --- |
| [Shared Dependency Cache and Checkout Upgrade](./shared-dependency-cache-and-checkout.md) | Active | SDC-001 shares safe Bun/Chromium restores through GitHub ref scoping; SDC-002 upgrades all workflow checkout pins to v7.0.1 and requires hosted Quality proof. |
