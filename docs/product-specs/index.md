...
| Spec | Status | Notes |
| --- | --- | --- |
| [Docs Cloudflare and Alchemy deployment](./docs-cloudflare-alchemy-deployment.md) | Active — DCD-004 in progress | Main-sourced Preview `pr-24`, fixed Production, report-only and exact Preview teardown absence receipts are promoted (`31338052297`, `31343392260`, `31344401196`, `31350160353`); DCD-004 awaits primary-owner closeout, while DCD-005/final parity review remain pending. |
