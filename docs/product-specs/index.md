...
| Spec | Status | Notes |
| --- | --- | --- |
| [Alchemy deployment structure corrections](./alchemy-deployment-structure-corrections.md) | Active | Accepted implementation for findings `ALC-AUD-001` through `ALC-AUD-005` and decisions `ALC-AUD-R001` through `ALC-AUD-R003`; the [active plan](../exec-plans/active/alchemy-deployment-structure-corrections.md) owns ordered delivery and claim-matched closeout. |
