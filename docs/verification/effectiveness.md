...
Candidate `7c8a96e` supplies the current evidence for the router and
skill/profile/gate `Retain` decisions. The invalidated and rejected candidates
remain useful terminal evidence but cannot qualify the corrected profile or
gate.
